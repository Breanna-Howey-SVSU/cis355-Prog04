...
class Customer { 
    ...
    function insert_db_record () {
		...
		if ($fileName != "") {
			...
			$filePath = "https://breannahowey-cis255-2018.000webhostapp.com/cis355-Prog04/uploads/" . $fileName;
	...
	//	$fileLocation = "breannahowey-cis255-2018.000webhostapp.com/cis355-Prog04/uploads/";
		...
		if (!file_exists($fileFullPath)) {
			...
			if ($result) {
				...
				// plus the string, $fileLocation, i.e. "cis355-Prog04/uploads/"
    ...
    private function generate_html_top ($fun, $id=null) {
        switch ($fun) {
            case 1: // create
                $funWord = "Create"; $funNext = "insert_db_record"; // change to send_email when server allows mail() function
                break;
            case 2: // read
